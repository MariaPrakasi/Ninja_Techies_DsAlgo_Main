...
#
  Scenario: User validates Introduction in Linked List page
    ...
    And clicks on Run button in Introduction of Linked List page
    Then user is navigated to home page "https://dsportalapp.herokuapp.com/home"
    
    Scenario: User validates Creating Linked List in Linked List page
    ...
    And clicks on Run button in Creating Linked List in Linked List page
    Then user is navigated to home page "https://dsportalapp.herokuapp.com/home"
    
    Scenario: User validates Types of Linked List in Linked List page
    ...
    And clicks on Run button in Types of Linked List in Linked List page
    Then user is navigated to home page "https://dsportalapp.herokuapp.com/home"
    
    Scenario: User validates Implement Linked List in python in Linked List page
    ...
    And clicks on Run button in Implement Linked List in python in Linked List page
    Then user is navigated to home page "https://dsportalapp.herokuapp.com/home"
    
    Scenario: User validates Traversal in Linked List page
    ...
    And clicks on Run button in Traversal of Linked List page
    Then user is navigated to home page "https://dsportalapp.herokuapp.com/home"
    
    Scenario: User validates Insertion in Linked List page
    ...
    And clicks on Run button in Insertion of Linked List page
    Then user is navigated to home page "https://dsportalapp.herokuapp.com/home"
    
    
    Scenario: User validates Deletion in Linked List page
    ...
    And clicks on Run button in Deletion of Linked List page
    Then user is navigated to home page "https://dsportalapp.herokuapp.com/home"
